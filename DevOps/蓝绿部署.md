...
source "$SCRIPT_DIR/NginxShell/NginxSwitch.sh"
# 获取脚本退出状态码
EXIT_CODE=$?
...
def worker_requests():
    ...
    while True:
        try:
            # 发送 GET 请求
            response = requests.get(TARGET_URL, timeout=10)  # 超时时间为 5 秒
...
def worker_session():
    ...
    while True:
        try:
            # 发送 GET 请求
            response = session.get(TARGET_URL, timeout=10)  # 超时时间为 5 秒
            if response.status_code == 200:
                with lock:
                    success_count += 1
                # 将成功的响应放入队列
...
```
请求失败: HTTPConnectionPool(host='47.113.186.151', port=80): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPConnection object at 0x0000023E709AA470>, 'Connection to 47.113.186.151 timed out. (connect timeout=10)'))
请求失败: HTTPConnectionPool(host='47.113.186.151', port=80): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPConnection object at 0x0000023E709AAFB0>, 'Connection to 47.113.186.151 timed out. (connect timeout=10)'))
请求失败: HTTPConnectionPool(host='47.113.186.151', port=80): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPConnection object at 0x0000023E70EC68C0>, 'Connection to 47.113.186.151 timed out. (connect timeout=10)'))
每秒成功请求数: 367
请求失败: HTTPConnectionPool(host='47.113.186.151', port=80): Max retries exceeded with url: / (Caused by ConnectTimeoutError(<urllib3.connection.HTTPConnection object at 0x0000023E709ABAF0>, 'Connection to 47.113.186.151 timed out. (connect timeout=10)'))
随机选择的响应内容:
