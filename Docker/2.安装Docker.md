...
官方网站上有各种环境下的 [安装指南](https://docs.docker.com/install/)，安装演示为 Docker CE 在 CentOS上的安装
...
> {
>   "registry-mirrors": [
> 	"https://bjwkpbin.mirror.aliyuncs.com","https://mirrors.tuna.tsinghua.edu.cn","http://hub-mirror.c.163.com","https://docker.mirrors.ustc.edu.cn"
> 	]
> }
> ```
